...
ANNA: "Step one, look at the scene. Step two, ask questions. Step three, follow the clues. Ta-da!"
...
=== TEACHER_DESK ===
You pull gently on the teacher’s desk drawer. It squeaks open. Papers, chalk, and… a notebook!

Your heart jumps, until you see it’s orange, not red.

Anna laughs.
ANNA: "Detective note: wrong color. Close, but not the one!"
...
ANNA: "Nice! One clue found. You’re getting good at this."
~ found_pages += 1
...
CLASSMATE smirks: "Sure. Here it is."
...
LIBRARIAN: "Hmm… I saw a red notebook with a banana sticker. Pages were falling out everywhere."
...
Anna: "Our suspect leaves clues everywhere. The janitor is like a Banana Sticker Thief."
...
CLASSMATE: "Maybe. I see a lot of things."

Anna crosses her arms.
ANNA: "Come on. Just tell us."

The classmate shrugs.
CLASSMATE: "Fine. I saw the janitor carrying something like that. He was going to the cafeteria."
...
ANNA: "Detective rule number one: never work on an empty stomach. But fine, let’s focus!"
...
STUDENT (smiling): "Looking for a red notebook? I have it."

He hands you a notebook.
You open it quickly, but it’s full of banana superheroes.

Anna laughs out loud.
ANNA: "First banana cartoons, now banana heroes? This school really loves bananas!"

You sigh and hand it back.
STUDENT: "Couldn’t resist a joke."
-> CAF_EXPLORE
...
COOK sighs.
COOK: "Red cover, banana sticker? Yes, the janitor dropped it here earlier. Pages everywhere!"
...
Anna nudges you.
ANNA: "Okay, detective. The janitor’s room is at the end of the hall. But remember, hallways hide secrets too."

You look around. Where should you go?
...
=== JANITOR_ROOM ===
You reach the janitor’s closet. The door is half open, creaking slightly.
Inside, the air smells of cleaning supplies and old wood.

On the desk lies your red notebook, banana sticker glinting under the flickering light.
Nearby, loose pages are stacked haphazardly, some taped with more stickers.
...
The fresh air smells of grass and chalk dust from the hopscotch squares.
