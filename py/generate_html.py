...
def generate_stories_js():
    """Emit js/stories.js from stories/stories-manifest.json (single source of truth)."""
    manifest_path = os.path.join(root_dir, "stories", "stories-manifest.json")
    out_path = os.path.join(root_dir, "js", "stories.js")
    with open(manifest_path, "r", encoding="utf-8") as f:
        stories = json.load(f)
    if not isinstance(stories, list):
        raise ValueError("stories-manifest.json must contain a JSON array")
    ...
    body = "export const allStories = " + json.dumps(
        stories, indent=4, ensure_ascii=False
    ) + ";\n"
    os.makedirs(os.path.dirname(out_path), exist_ok=True)
    with open(out_path, "w", encoding="utf-8") as f:
        f.write(header + body)
    print(f"Generated {out_path} from {manifest_path}")
